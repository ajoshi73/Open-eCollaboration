...
var OF_Form = function(element, options) {
    ...
    this.options = {
        ...
        lang: {
            mustNotBeEmpty: 'Fältet får inte vara tomt',
            mustChoose: 'Du måste välja minst %d alternativ',
            mustBeEmail: 'Fältet måste vara en e-postadress',
            mustBeNumeric: 'Fältet får endast innehålla siffror',
            defaultError: 'Fältet validerar inte',
            mustMatch: 'Lösenorden överrensstämmer inte'
        }
    };
    ...
    this.handle = function() {
        ...
        $(window).on('keydown', function(e) {
            ...
            if (b.find('> span').is(':focus') && a.hasClass('active') && key == 38) {
                ...
                // TODO: Vid pil upp måste scrollen hänga med...
        ...
        if (multiple !== false) {
            ...
            b.find('> span').on('keydown', function(e) {
                ...
                var key = e.keyCode ? e.keyCode : e.which,
                    ...
                    reg,
                    errorLi = $('<li/>').addClass('error').text('Inga poster matchade sökningen "' + fullVal + '"');
                try {
...
jQuery(function($) {
    $.datepicker.regional['sv_SE'] = {
        ...
        dayNamesMin: ['Sö', 'Må', 'To', 'On', 'To', 'Fr', 'Lö'],
        weekHeader: 'V',
        dateFormat: 'yy-mm-dd',
        firstDay: 1,
        isRTL: false,
