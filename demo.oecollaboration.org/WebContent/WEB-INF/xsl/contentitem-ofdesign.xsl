...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="document">
		...
		<head>
			...
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/of-assets/css/of-master.css" />
		...
		<body class="non-responsive of-no-header">
			...
			<main id="content" class="of-main-padded">
				...
				<div class="of-wrap of-wrap-no-padding">
					...
					<div>
						...
						<div class="of-omega-sm of-omega-md  of-inner-padded-t of-c-sm-4 of-c-lg-7 of-center of-omega-lg of-omega-xl of-omega-xxl of-omega-xxxl">
						
							<div class="of-block of-padding-mobile">
			...
			<!--<footer role="contentinfo">
				<div class="of-wrap">
					<div class="of-omega-xs-extend of-c-xl-flexible-10 of-right">
						<a class="of-footer-logo" href="#"> <img src="{/document/requestinfo/contextpath}/of/assets/images/sundsvalls-kommun.svg" alt="Sundsvall Kommun"/>
						</a>
						<ul class="of-footer-list">
							<li><a href="#">Kontakta IT-service</a></li>
							<li><a href="#">Vanliga frågor</a></li>
							<li>Vi använder oss av <a href="#">cookies</a></li>
						</ul>
					</div>
				</div>
			</footer>-->
		 
			<script src="{/document/requestinfo/contextpath}/of/of-assets/js/of-master.js" type="text/javascript"></script>
