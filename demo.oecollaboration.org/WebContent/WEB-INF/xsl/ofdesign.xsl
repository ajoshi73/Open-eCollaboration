...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="document">
		...
		<xsl:text disable-output-escaping="yes"><![CDATA[<!--[if lt IE 8]><html class="no-js lt-ie10 lt-ie9 lt-ie8"><![endif]-->]]></xsl:text>
		<xsl:text disable-output-escaping="yes"><![CDATA[<!--[if IE 8]><html class="no-js lt-ie10 lt-ie9"><![endif]-->]]></xsl:text>
		<xsl:text disable-output-escaping="yes"><![CDATA[<!--[if IE 9]><html class="no-js lt-ie10 lt-ie9"><![endif]-->]]></xsl:text>	
		<xsl:text disable-output-escaping="yes"><![CDATA[<!--[if gt IE 8]><!--><html class="no-js" lang="sv"><!--<![endif]-->]]></xsl:text>	
	
		<head>
		
			<title>
				<xsl:text>Samarbetsrum</xsl:text>
				<xsl:if test="title">	
					<xsl:text> - </xsl:text>
			...
			<link rel="shortcut icon" href="{/document/requestinfo/contextpath}/favicon.ico?v=3"/>
		    
			<script type="text/javascript" src="{/document/requestinfo/contextpath}/static/global/jquery/jquery.js"/>
			<script type="text/javascript" src="{/document/requestinfo/contextpath}/static/global/jquery/jquery-migrate.js"/>
			<script type="text/javascript" src="{/document/requestinfo/contextpath}/static/global/jquery/jquery-ui.js"/>
			
			<script src="{/document/requestinfo/contextpath}/mockup-release/components/of-modal/of-modal.min.js" type="text/javascript"></script>
			
			<xsl:apply-templates select="scripts/script[src != '/static/global/jquery/jquery.js' and src != '/static/global/jquery/jquery-migrate.js' and src != '/static/global/jquery/jquery-ui.js']" />
			
			<script src="{/document/requestinfo/contextpath}/of/of-assets/js/dependencies/modernizr-2.7.0.min.js"></script>
			<script src="{/document/requestinfo/contextpath}/js/init.js"></script>
			
			<link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,600,400italic,600italic" rel="stylesheet" type="text/css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/of-assets/css/of-master.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/components/of-button/of-button.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/components/of-sidebar/of-sidebar.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/components/of-calendar/of-calendar.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/components/of-modal/of-modal.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/components/of-system-message/of-system-message.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/components/of-sidebar-menu/of-sidebar-menu.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/components/of-main-menu/of-main-menu.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/components/of-facepile/of-facepile.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/components/of-rss-feed/of-rss-feed.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/components/of-tooltip/of-tooltip.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/components/of-notification-menu/of-notification-menu.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/components/of-profile-menu/of-profile-menu.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/components/of-tables/of-tables.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/components/of-toolbox/of-toolbox.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/components/of-fileupload/of-fileupload.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/components/of-search/of-search.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/components/of-breadcrumbs/of-breadcrumbs.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/components/of-steps/of-steps.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/components/of-progress/of-progress.min.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/of/assets/css/samarbetsrum.css" />
			
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/css/style.css" />
			<link rel="stylesheet" href="{/document/requestinfo/contextpath}/custom/css/custom-overrides.css" />
		...
		<body class="non-responsive">
			...
			<div style="width: 0; height: 0; position: absolute; left: -999px">
				...
				<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
					...
					<symbol id="table">
						<title>Tabell</title>
						<path d="m 179.242,218.095 237.714,0 c 26.274,0 47.544,-18.409 47.544,-41.198 0,-22.699 -21.27,-41.198 -47.544,-41.198 l -237.714,0
							c -26.273,0 -47.543,18.41 -47.543,41.198 0,22.699 21.27,41.198 47.543,41.198 z" />
			     	<path d="m 416.956,284.401 -237.714,0 c -26.273,0 -47.543,18.409 -47.543,41.198 0,22.789 21.27,41.197 47.543,41.197 l 237.714,0
			     		c 26.274,0 47.544,-18.408 47.544,-41.197 0,-22.789 -21.269,-41.198 -47.544,-41.198 z" />
			    	<path d="M416.956,429.104H179.242c-26.273,0-47.543,18.408-47.543,41.197s21.27,41.198,47.543,41.198h237.714
			    		c26.274,0,47.544-18.409,47.544-41.198C464.5,447.604,443.231,429.104,416.956,429.104z"/>
    				<path d="M81.662,465.804V237.326c0-25.253-17.693-45.696-39.597-45.696S2.468,212.073,2.468,237.326v228.478
    				  c0,25.253,17.694,45.696,39.598,45.696C63.882,511.5,81.662,491.057,81.662,465.804z"/>
       			<path d="M81.695,273.674V45.196C81.695,19.943,64.001-0.5,42.098-0.5S2.5,19.943,2.5,45.196v228.478
       			  c0,25.253,17.694,45.696,39.598,45.696C63.914,319.37,81.695,298.927,81.695,273.674z"/>
      	 		<path d="M278.304-0.5H49.826C24.573-0.5,4.13,17.193,4.13,39.097s20.443,39.598,45.696,39.598h228.478
      	 		  C303.557,78.694,324,61,324,39.097C324,17.28,303.557-0.5,278.304-0.5z"/>
       			<path d="M465.804-0.5H237.326c-25.253,0-45.696,17.693-45.696,39.597s20.443,39.598,45.696,39.598h228.478
       			  c25.253,0,45.696-17.694,45.696-39.598C511.5,17.28,491.057-0.5,465.804-0.5z"/>
					</symbol>					
				</svg>
			</div>
			...
			<div class="outdated-browser">
				<p>
					<img src="{/document/requestinfo/contextpath}/of/assets/images/sad.png" alt="Inget browserstöd"/>
			...
			<div class="of-modal-backdrop" />
		
			<xsl:variable name="headerBgResponses" select="backgroundsModuleResponses/response[slots/slot = 'header']" />
		
			<header class="of-header" role="banner">
		
				<div class="of-wrap">
					
					<div class="samarbetsrum-header-section samarbetsrum-logo">
						<a class="of-icon of-icon-only of-hide-to-md" href="{/document/requestinfo/contextpath}/">
							<!-- <i><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512"><use xlink:href="#logo-full"></use></svg></i> -->
							<img src="{/document/requestinfo/contextpath}/custom/images/sr-logo.png" alt="Samarbetsrum"/>
							<span>Samarbetsrum</span>
						</a>
	
						<a class="of-icon of-icon-lg of-hide-from-md" href="{/document/requestinfo/contextpath}/">
							<i><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512"><use xlink:href="#house"></use></svg></i>
							<span>Start</span>
						</a>
					</div>
		
					<xsl:if test="$headerBgResponses">
						<xsl:apply-templates select="$headerBgResponses" />
					</xsl:if>
		
					<!-- section for search field and search result -->
		
					<!-- <div class="samarbetsrum-header-section samarbetsrum-search"></div> -->
		
					<!-- Section for notifications -->
		
					<xsl:if test="user">
					
						<xsl:for-each select="backgroundsModuleResponses/response[slots/slot = 'notifications']">
					...
					<div class="samarbetsrum-header-section samarbetsrum-profile">
						
						<xsl:choose>
						
							<xsl:when test="user">
							
								<div class="of-profile-menu">
									<a class="of-icon" href="#" data-toggle="of-profile-menu"> <span class="of-hide-to-xl"><xsl:value-of select="user/firstname" /><xsl:text>&#160;</xsl:text><xsl:value-of select="user/lastname" /></span>
										<figure class="of-profile">
											<img alt="{user/firstname} {user/lastname}" src="{/document/requestinfo/contextpath}/userprofile/profileimage/{user/userID}" />
										</figure> <i><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
										<use xlink:href="#arrow-down"></use></svg></i>
									</a>
									<ul>
										<li>
											<a class="of-icon" href="{/document/requestinfo/contextpath}/userprofile"> <i><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
												<use xlink:href="#profile"></use></svg></i> <span>Min profil</span>
											</a>
										</li>
										<li>
											<a class="of-icon" href="{/document/requestinfo/contextpath}/"> <i><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
												<use xlink:href="#house"></use></svg></i><span>Min startsida</span>
											</a>
										</li>
										<li>
											<a class="of-icon" href="{/document/requestinfo/contextpath}/mytasks">
										...
										<li>
											<a class="of-icon" href="{/document/requestinfo/contextpath}/mycalendar">
												<i><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512"><use xlink:href="#calendar"></use></svg></i>
												<span>Min kalender</span>
											</a>
										</li>
										<xsl:variable name="systemAdminLink" select="menus/menu/menuitem[sectionMenuItem/subSectionID = 4]" />
										<xsl:if test="$systemAdminLink">
											<li>
												<a class="of-icon" href="{/document/requestinfo/contextpath}{$systemAdminLink/url}"> <i><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
													<use xlink:href="#cog"></use></svg></i> <span><xsl:value-of select="$systemAdminLink/name" /></span>
												</a>
											</li>
										</xsl:if>
										<li><a class="of-block-link" href="{/document/requestinfo/contextpath}/logout">Logga ut</a></li>
									</ul>
								</div>
							...
							<xsl:otherwise>
								...
								<a href="{/document/requestinfo/uri}?triggerlogin=1" class="of-btn of-btn-center of-btn-gronsta of-icon" style="padding-left: 5px; padding-right: 5px;">
									<span>Logga in</span>
								</a>
			...
			<main id="content" class="of-main-padded">
		
				<div class="of-wrap of-wrap-no-padding">
				
					<!-- Left menu -->
				
					<xsl:variable name="leftMenuBgResponses" select="backgroundsModuleResponses/response[slots/slot = 'left-menu']" />
					
					<xsl:variable name="level1MenuItems" select="menus/menu/menuitem[itemType!='SECTION'][not(bundle)][not(@bundled)]" />
					<xsl:variable name="level2MenuItems" select="menus/menu/menuitem/menu/menuitem[not(bundle)][not(@bundled)]" />
					<xsl:variable name="bundleMenuItems" select="menus/menu/menuitem/menu/menuitem[bundle]" />
				
					<xsl:variable name="menuVisible" select="$level1MenuItems or level2MenuItems or $bundleMenuItems or $leftMenuBgResponses" />
				
					<xsl:if test="$menuVisible">
					
						<div class="of-c-lg-fixed-2">
				
							<nav class="of-sidebar-menu of-hide-to-lg">
				
								<xsl:if test="$leftMenuBgResponses">
									<xsl:apply-templates select="$leftMenuBgResponses" />
								</xsl:if>
				
								<xsl:if test="$level2MenuItems">
									<a href="{/document/requestinfo/contextpath}/" class="of-btn of-btn-center of-btn-svartvik of-icon">
										<i><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
											<use xlink:href="#house"></use></svg>
										</i>
										<span>Min startsida</span>
									</a>
								</xsl:if>
				
								<xsl:if test="$level1MenuItems or $level2MenuItems or $bundleMenuItems">
									<h3>Innehåll</h3>
					
									<ul data-of-menu="main">
										<xsl:choose>
											<xsl:when test="not($level2MenuItems)">
												<xsl:apply-templates select="$level1MenuItems" />
											</xsl:when>
											<xsl:otherwise>
												<xsl:apply-templates select="$level2MenuItems" />
											</xsl:otherwise>
										</xsl:choose>
									</ul>
					
									<xsl:if test="$bundleMenuItems">
										<xsl:apply-templates select="$bundleMenuItems" mode="bundle" />									
									</xsl:if>
								</xsl:if>
					...
					<xsl:variable name="mainRightBgResponses" select="backgroundsModuleResponses/response[slots/slot = 'main-right']" />
					<xsl:variable name="mainTopBgResponses" select="backgroundsModuleResponses/response[slots/slot = 'main-top']" />
					<xsl:variable name="mainBottomBgResponses" select="backgroundsModuleResponses/response[slots/slot = 'main-bottom']" />
					
					<!-- Main content -->
					
					<div class="of-c-lg-flexible-12 of-omega-sm-extend">
			
						<xsl:if test="$menuVisible">
							<xsl:attribute name="class">of-c-lg-flexible-10 of-omega-sm-extend</xsl:attribute>
						</xsl:if>
			
						<div class="of-omega-sm of-omega-md  of-omega-lg-extend of-c-lg-flexible-12">
							
							<xsl:if test="$mainRightBgResponses">
								<xsl:attribute name="class">of-omega-sm of-omega-md of-c-xl-flexible-9</xsl:attribute>
							</xsl:if>
							...
							<xsl:if test="$menuVisible">
								...
								<nav class="of-sidebar-menu of-hide-from-lg mobile-menu">
									...
									<xsl:if test="$level1MenuItems or level2MenuItems or $bundleMenuItems">
										...
										<ul data-of-menu="main">
											<xsl:choose>
												<xsl:when test="not($level2MenuItems)">
													<li class="of-hide-from-lg">
														<a href="{/document/requestinfo/contextpath}/addsection" class="of-icon">
							...
							<!-- Slot for top content background modules. of-no-margin sholud only be added if any right content. Maybe margin should be place on content wrapper instead? -->
							
							<!-- Main top content slot (background module responses) -->
							
							<xsl:if test="$mainTopBgResponses">
								
								<!-- <div class="of-block of-module of-no-margin">
									<xsl:if test="$mainTopBgResponses and $mainRightBgResponses">
										<xsl:attribute name="class">of-block of-module</xsl:attribute>
									</xsl:if>
									<xsl:apply-templates select="$mainTopBgResponses" />
								</div> -->
							...
							<!-- Main content (foreground module response) -->
							
							<div class="of-dialog-block" style="clear: both;">
							...
							<!-- Main bottom content slot (background module responses) -->
			
							<xsl:if test="$mainBottomBgResponses">
								
								<xsl:apply-templates select="$mainBottomBgResponses" />
								
							</xsl:if>
			
						</div>
						
						<!-- Main right content slot (background module responses) -->
						
						<xsl:if test="$mainRightBgResponses">
							<div class="of-c-sm-4 of-omega-sm-extend of-c-xl-fixed-3">
								<xsl:apply-templates select="$mainRightBgResponses" mode="main-right" />
							</div>
						</xsl:if>
			...
			<xsl:variable name="footerBgResponses" select="backgroundsModuleResponses/response[slots/slot = 'footer']" />
		
			<footer role="contentinfo">
				<div class="of-wrap">
					<div class="of-omega-xs-extend of-c-xl-flexible-10 of-right">
						<xsl:apply-templates select="$footerBgResponses" />
					</div>
				</div>
			</footer>
		
			<script src="{/document/requestinfo/contextpath}/of/of-assets/js/of-master.min.js" type="text/javascript"></script>
			<script src="{/document/requestinfo/contextpath}/of/components/of-calendar/of-calendar.min.js" type="text/javascript"></script>
			<script src="{/document/requestinfo/contextpath}/of/components/of-notification/of-notification.min.js" type="text/javascript"></script>
			<script src="{/document/requestinfo/contextpath}/of/components/of-forms/of-forms.min.js" type="text/javascript"></script>
			<script src="{/document/requestinfo/contextpath}/of/components/of-tooltip/of-tooltip.min.js" type="text/javascript"></script>
			<script src="{/document/requestinfo/contextpath}/of/components/of-tables/of-tables.min.js" type="text/javascript"></script>
			<script src="{/document/requestinfo/contextpath}/of/components/of-toolbox/of-toolbox.min.js" type="text/javascript"></script>
			<script src="{/document/requestinfo/contextpath}/of/components/of-fileupload/of-fileupload.min.js" type="text/javascript"></script>
			<script src="{/document/requestinfo/contextpath}/of/components/of-progress/of-progress.min.js" type="text/javascript"></script>
			<script src="{/document/requestinfo/contextpath}/of/assets/js/samarbetsrum.js" type="text/javascript"></script>							
	...
	<xsl:template match="menuitem" mode="bundle">
		...
		<xsl:variable name="uniqueID" select="bundle/uniqueID" />
		...
		<div class="of-inner-padded-t">
			...
			<ul class="data-of-menu">
				<xsl:apply-templates select="../menuitem[moduleMenuItem/uniqueID = $uniqueID]" />
			</ul>
	...
	<xsl:template match="menuitem">
			...
			<xsl:choose>
				<xsl:when test="url">
					...
					<a class="of-icon">
						...
						<xsl:if test="name = 'Skapa sida'"><xsl:attribute name="title"><xsl:value-of select="description" /></xsl:attribute></xsl:if>
					
						<!-- Temporary until menuitem is supporting icons -->
		...
		<xsl:apply-templates select="menu/menuitem[itemType = 'SECTION']" />
	...
	<xsl:template name="printIcon">
		...
		<xsl:variable name="icon">
			<xsl:choose>
				<xsl:when test="$menuitem/name = 'Överblick'">eye</xsl:when>
				<xsl:when test="$menuitem/name = 'Min startsida'">house</xsl:when>
				<xsl:when test="$menuitem/name = 'Inlägg'">posts</xsl:when>
				<xsl:when test="$menuitem/name = 'Uppgifter' or $menuitem/name = 'Mina uppgifter'">checkmark</xsl:when>
				<xsl:when test="$menuitem/name = 'Kalender' or $menuitem/name = 'Min kalender'">calendar</xsl:when>
				<xsl:when test="$menuitem/name = 'Filer'">file</xsl:when>
				<xsl:when test="$menuitem/name = 'Deltagare'">group</xsl:when>
				<xsl:when test="$menuitem/name = 'Inställningar'">cog</xsl:when>
				<xsl:when test="$menuitem/name = 'Skapa sida'">plus</xsl:when>
				<xsl:when test="$menuitem/name = 'Rumsöversikt'">eye</xsl:when>
				<xsl:when test="$menuitem[@bundled]">file</xsl:when>
	...
	<xsl:template match="response" mode="main-right">
		
		<div class="of-c-sm-4 of-omega-sm of-omega-md of-c-lg-4 of-c-xl-8 of-omega-xl-extend">
			<xsl:value-of select="HTML" disable-output-escaping="yes" />
		</div>
