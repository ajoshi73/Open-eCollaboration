...
(function($) {
    ...
    $(function() {
        ...
        /* Swiper */
        if ($('.of-slider').length > 100) {
            $('.of-slider').swiper({
                wrapperClass: 'of-slides',
                slideClass: 'of-slide',
                mode: 'horizontal',
                loop: false,
                speed: 500,
                ...
                onSwiperCreated: function(swiper) {
                    ...
                    var activeIndex = (swiper.activeIndex + 1),
                        theme = $(swiper.container).find('div').eq(activeIndex).attr('class').replace('swiper-slide ', '');

                    $(swiper.container).removeClass('dark light');
                    $(swiper.container).addClass(theme);
                },
