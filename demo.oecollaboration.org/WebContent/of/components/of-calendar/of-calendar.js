...
(function($) {
    ...
    $(function() {
        ...
        $('.of-calendar').each(function(calendarIndex) {
            ...
            var daysOfTheWeek = isWidget ? ['Må', 'Ti', 'On', 'To', 'Fr', 'Lö', 'Sö'] : ['Må<span class="of-hide-to-sm">ndag</span>', 'Ti<span class="of-hide-to-sm">sdag</span>', 'On<span class="of-hide-to-sm">sdag</span>', 'To<span class="of-hide-to-sm">rsdag</span>', 'Fr<span class="of-hide-to-sm">edag</span>', 'Lö<span class="of-hide-to-sm">rdag</span>', 'Sö<span class="of-hide-to-sm">ndag</span>'];
...
function getWidgetDay(events, html) {
    ...
    if (typeof events === 'undefined' || events.length === 0) {
        ...
        out = '<li class="empty">Inga kalenderhändelser idag</li>';
        return html ? out : $(out);
    }
